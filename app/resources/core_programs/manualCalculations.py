...
def calcThetas(nucDict, numStrains, ancestralSeq):
            ...
            for seqIndex in range(0, numSeq):
                ...
                if sum(mutsInCodon) == 3:  # This gets ridiculous fast...
                    ...
                    if table[consensusCodon] == table[
                        inBetween12_1]:  # Compare consensus to possibility part 1 of paths 1 and 2 [Weight = 2]
                        totSynFound += 2.0
                    else:
                        totNonSynFound += 2.0
                    ...
                    totSynFound = 0.0
                    totNonSynFound = 0.0
                    if table[consensusCodon] == table[inBetween1]:  # Compare consensus to first between possibility
                        totSynFound += 1.0
                    else:
                        totNonSynFound += 1.0
                    if table[inBetween1] == table[actualCodon]:  # Compare first between possibility to actual
                        ...
                        totNonSynFound += 1.0
                    if table[consensusCodon] == table[inBetween2]:  # Compare consensus to second between possibility
                        totSynFound += 1.0
                    else:
                        totNonSynFound += 1.0
    ...
    # 'float' everywhere because thanks python
